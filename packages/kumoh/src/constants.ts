export const PLUGIN_NAME = 'kumoh';

export const VIRTUAL_PREFIX = 'kumoh/';
export const RESOLVED_PREFIX = '\0kumoh/';
...
export const VIRTUAL_ROUTE = 'kumoh/route';
export const VIRTUAL_MIDDLEWARE = 'kumoh/middleware';
