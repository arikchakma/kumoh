...
function generateTypes(config: KumohConfig, root: string): void {
  ...
  sections.push(
    ...
    'type KumohHandler<P extends string = any> = (c: Context<KumohEnv, P>) => Response | Promise<Response>;',
    '',
    "declare module 'kumoh/app' {",
    '  export function defineApp(',
    '    init: (app: Hono<KumohEnv>) => void',
    '  ): (app: Hono<KumohEnv>) => void;',
    '  export function defineHandler<P extends string = any>(',
    '    handler: KumohHandler<P>',
    '  ): KumohHandler<P>;',
